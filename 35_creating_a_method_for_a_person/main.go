...
import (
	...
	"github.com/ouzrourextra/go_medium_lvl/35_creating_a_method_for_a_person/err"
	"github.com/ouzrourextra/go_medium_lvl/35_creating_a_method_for_a_person/input"
)
...
func (p Person) Hello() {
	fmt.Printf("\n============================\n")
	fmt.Printf("Hello %s ! Your age is : %d and your mail is : %s ! \n", p.name, p.age, p.email)
	fmt.Printf("============================\n")
}
...
func main() {
	...
	for _, value := range ListOfPersons {
		value.Hello()
	}
}
